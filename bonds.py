...
cal = Brazil()
"""
Aqui ainda temos que desenvolver a sintaxe adequada para o cython.
Além de revisar e incluir as funções relativas à sensibilidade dos títulos de renda fixa. 
Acho que é melhor fazer isso no notebook de renda fixa e depois transferir as mudanças para esse arquivo.
"""
